...
function CitrusSvg({ className, style }: SvgProps) {
  return (
    <svg viewBox="0 0 200 200" fill="none" xmlns="http://www.w3.org/2000/svg" className={className ?? 'w-full h-full'} style={style}>
...
function FloralSvg({ className, style }: SvgProps) {
  return (
    <svg viewBox="0 0 200 200" fill="none" xmlns="http://www.w3.org/2000/svg" className={className ?? 'w-full h-full'} style={style}>
      {/* Five petals */}
...
function WoodySvg({ className, style }: SvgProps) {
  return (
    <svg viewBox="0 0 200 200" fill="none" xmlns="http://www.w3.org/2000/svg" className={className ?? 'w-full h-full'} style={style}>
      {/* Tree rings */}
...
function FruitySvg({ className, style }: SvgProps) {
  return (
    <svg viewBox="0 0 200 200" fill="none" xmlns="http://www.w3.org/2000/svg" className={className ?? 'w-full h-full'} style={style}>
      {/* Three berries */}
...
function SpicySvg({ className, style }: SvgProps) {
  return (
    <svg viewBox="0 0 200 200" fill="none" xmlns="http://www.w3.org/2000/svg" className={className ?? 'w-full h-full'} style={style}>
      {/* Star anise — 8 points */}
...
function EarthySvg({ className, style }: SvgProps) {
  return (
    <svg viewBox="0 0 200 200" fill="none" xmlns="http://www.w3.org/2000/svg" className={className ?? 'w-full h-full'} style={style}>
      {/* Mushroom cap */}
...
function MuskySvg({ className, style }: SvgProps) {
  return (
    <svg viewBox="0 0 200 200" fill="none" xmlns="http://www.w3.org/2000/svg" className={className ?? 'w-full h-full'} style={style}>
...
function ResinousSvg({ className, style }: SvgProps) {
  return (
    <svg viewBox="0 0 200 200" fill="none" xmlns="http://www.w3.org/2000/svg" className={className ?? 'w-full h-full'} style={style}>
      {/* Resin droplet */}
...
function LeatherSvg({ className, style }: SvgProps) {
  return (
    <svg viewBox="0 0 200 200" fill="none" xmlns="http://www.w3.org/2000/svg" className={className ?? 'w-full h-full'} style={style}>
...
function MossySvg({ className, style }: SvgProps) {
  return (
    <svg viewBox="0 0 200 200" fill="none" xmlns="http://www.w3.org/2000/svg" className={className ?? 'w-full h-full'} style={style}>
...
function GourmandSvg({ className, style }: SvgProps) {
  return (
    <svg viewBox="0 0 200 200" fill="none" xmlns="http://www.w3.org/2000/svg" className={className ?? 'w-full h-full'} style={style}>
      {/* Vanilla bean pod */}
...
function DefaultSvg({ name, className, style }: { name: string } & SvgProps) {
...
export function FamilyIllustration({ family, name = '', size, opacity, className }: FamilyIllustrationProps) {
  ...
  if (FamilySvg) {
    return <FamilySvg className={className} style={style} />;
  }
  return <DefaultSvg name={name} className={className} style={style} />;
}
